export const mockItems = [
  ...
  },
  {
    ...
    address: {
      label:
        'Maximilian Munich, Hochbrückenstraße 18, 80331 München, Deutschland',
      countryCode: 'DEU',
      countryName: 'Deutschland',
      stateCode: 'BY',
      state: 'Bayern',
  ...
  },
  {
    ...
    address: {
      label:
        'Internet Cafe Isartor / Marienplatz, Thomas-Wimmer-Ring 1, 80539 München, Deutschland',
      countryCode: 'DEU',
      countryName: 'Deutschland',
      stateCode: 'BY',
      state: 'Bayern',
  ...
  },
  {
    ...
    address: {
      label:
        'Hotel Splendid-Dollmann, Thierschstraße 49, 80538 München, Deutschland',
      countryCode: 'DEU',
      countryName: 'Deutschland',
      stateCode: 'BY',
      state: 'Bayern',
  ...
  },
  {
    ...
    address: {
      label:
        'Bezirksfinanzdirektion Muenchen, Ländstraße 6, 80538 München, Deutschland',
      countryCode: 'DEU',
      countryName: 'Deutschland',
      stateCode: 'BY',
      state: 'Bayern',
  ...
  },
  {
    ...
    address: {
      label:
        'Appartment München Isartor, Ländstraße 6, 80538 München, Deutschland',
      countryCode: 'DEU',
      countryName: 'Deutschland',
      stateCode: 'BY',
      state: 'Bayern',
  ...
  },
  {
    ...
    address: {
      label:
        'Hotel vier Jahreszeiten Kempinski, Maximilianstraße 17, 80539 München, Deutschland',
      countryCode: 'DEU',
      countryName: 'Deutschland',
      stateCode: 'BY',
      state: 'Bayern',
  ...
  },
  {
    ...
    address: {
      label:
        'Hotel an der Isar, Steinsdorfstraße 15, 80538 München, Deutschland',
      countryCode: 'DEU',
      countryName: 'Deutschland',
      stateCode: 'BY',
      state: 'Bayern',
  ...
  },
  {
    ...
    address: {
      label:
        "Pusser's New York Bar, Falkenturmstraße 9, 80331 München, Deutschland",
      countryCode: 'DEU',
      countryName: 'Deutschland',
      stateCode: 'BY',
      state: 'Bayern',
